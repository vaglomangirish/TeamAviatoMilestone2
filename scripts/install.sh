...
mkdir '/home/ec2-user/registrytest-microservice'
cp -r /home/ec2-user/registry/* /home/ec2-user/registrytest-microservice

# delete revision
rm -rf '/home/ec2-user/registry'

echo 'Installing the Registry API...' 
cd '/home/ec2-user/registrytest-microservice/registry/'

sudo mvn clean install >> /var/log/tomcat.log
